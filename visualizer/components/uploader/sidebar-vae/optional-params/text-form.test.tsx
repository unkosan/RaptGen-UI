...
// describe('TextForm', () => {
//     it("should render placeholder if form is empty", () => {
//         const setValue = jest.fn();
//         const setIsValid = jest.fn();
//         const predicate = jest.fn();
//         render(<TextForm predicate={predicate} setValue={setValue} setIsValid={setIsValid} value={undefined} isValid={true} placeholder="placeholder" />);
...
//     it("value should be undefined if form is empty", () => {
...
//         render(<TextForm predicate={predicate} setValue={setValue} setIsValid={setIsValid} value={value} isValid={isValid} placeholder="placeholder" />);
//         const input = screen.getByPlaceholderText('placeholder');
