    ...
    let data = [
      {
        ...
        series: [
          {
            item_id: 0,
            item_datetime_start: 1620000000,
            item_duration_suspend: 6000,
            item_datetime_laststop: 1620012000,
            item_status: "failure",
          ...
          {
            item_id: 1,
            item_datetime_start: 1620012000,
            item_duration_suspend: 6000,
            item_datetime_laststop: 1620024000,
            item_status: "success",
            item_epochs_total: 1000,
          ...
          {
            item_id: 2,
            item_datetime_start: 1620024000,
            item_duration_suspend: 6000,
            item_datetime_laststop: 1620036000,
      ...
      },
      {
        ...
        series: [
          {
            item_id: 0,
            item_datetime_start: 1620000500,
            item_datetime_laststop: 1620012000,
            item_duration_suspend: 6000,
            item_status: "progress",
            item_epochs_total: 1000,
        ...
        series: [
          {
            item_id: 0,
            item_datetime_start: 1620000000,
            item_datetime_laststop: 1620010000,
            item_duration_suspend: 6000,
            item_status: "pending",
            item_epochs_total: 1000,
            item_epochs_current: 100,
      ...
      let data = [
        {
          ...
          id: 0,
          status: "failure",
          datetime_start: 1620000000,
          datetime_laststop: 1620012000,
          duration_suspend: 6000,
        ...
        },
        {
          ...
          id: 1,
          status: "success",
          datetime_start: 1620012000,
          datetime_laststop: 1620024000,
          duration_suspend: 6000,
          latent: latent,
          losses: losses,
        ...
        },
        {
          ...
          id: 2,
          status: "progress",
          datetime_start: 1620024000,
          datetime_laststop: null,
          duration_suspend: 6000,
          latent: latent,
          losses: losses,
        },
